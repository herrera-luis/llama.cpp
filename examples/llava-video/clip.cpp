...
struct clip_layer {
    ...
    //temporal attention Lora_A
   // struct ggml_tensor * temp_attn_k_lora_a_w;
   // struct ggml_tensor * temp_attn_k_lora_a_b;
    // New tensors for temporal attention
    struct ggml_tensor * temp_attn_k_lora_a_w;
    struct ggml_tensor * temp_attn_k_lora_a_b;
    struct ggml_tensor * temp_attn_k_lora_b_w;
    struct ggml_tensor * temp_attn_k_lora_b_b;
};
